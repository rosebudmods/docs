...
if you also want to get another player's perspective, you can use a mod like [freecam](https://modrinth.com/mod/XeEZ3fK2) to separate your camera from your body, or [carpet](https://modrinth.com/mod/TQTTVgYE) to create fake players (`/player [name] spawn`) which you can also override the skins of.
...
<CardGrid>
  ...
  <LinkCard
    title="carpet"
    description="get it on modrinth!"
    href="https://modrinth.com/mod/TQTTVgYE"
  />
</CardGrid>

## for roleplay

skin overrides allows you to change your skins and have them update immediately to other players on the server.

this works even if other players don't have the mod!

<Aside type="caution">
  while the mod works with vanilla clients, your cape will disappear on clients
  without the mod.
</Aside>
...
1. **install the mod on the server**
   ...
   if you're not the server's owner, you can ask them to do so. skin overrides can be [downloaded on modrinth](https://modrinth.com/mod/skin-overrides).

2. **add your skins to your library**

   open the overrides screen by pressing O when in game, or going to mod menu to open the config screen.

   from here, press the "open library" button in the bottom left.

   you can now drag & drop in your skins. it'll ask you what it should be called, and what model it uses. if you don't know what model the skin is, you can turn them around. if there's black lines on the back of the arms when it's wide, it's a slim skin.

3. **using your skins**

   when in the game, open the overrides screen. you can press "open library", select the skin you want, and pressing "use this!". this will change your skin!

   if you're using the skin for the first time, it may take a second to update. on future attempts, it'll be quicker!
